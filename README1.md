...
| # | Họ và Tên | Vai trò |
|:-:|:---|:---|
| 1 | **Lê Minh Huy** | Leader · Thuyết trình chính |
| 2 | **Nguyễn Tiến Đức** | Code chính — Thiết kế hệ thống & Pipeline AI |
| 3 | **Bùi Văn Ý** | Code phụ — Tối ưu hóa Streamlit & hiệu năng |
| 4 | **Dương Bích Tuyền** | Báo cáo — Cơ sở lý thuyết & kỹ thuật |
| 5 | **Nguyễn Tuyết Nhi** | Báo cáo — Thu thập dữ liệu & tổng hợp kết quả |
| 6 | **Trần Phước Lộc** | Thuyết trình — Demo ứng dụng thực tế |
...
| 9 | Feature Match | *(bỏ qua — chế độ một ảnh)* | — |
...
*Phát triển bởi nhóm nghiên cứu Thị giác Máy tính (Computer Vision) — Học kỳ 2 năm học 2025–2026*
